    ...
    <div className={styles.background}>
      <div className={styles.container}>
        <main className={styles.main}>
          <h1 className={styles.title}>  Let's Connect To CoinBase  </h1>
          {hasMinted && publicSaleData ? (
            ...
            <VStack>
              <p style={{ color: "black" }}>You're on the wrong Network!</p>
              <Button
                style={{
                  color: "#4b4f56",
                  borderRadius: "0",
